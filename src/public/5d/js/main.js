...
function downAndHidden() {
    ...
    $(".small-big .bet-type-btn").attr(
        "class",
        "bet-type-btn flex-row-between"
    );
    ...
    let result = datas.map((data) => {
      ...
      <div data-v-42f27458="" issuenumber="${
          ...
          <div data-v-42f27458="" class="item c-row">
            ...
            data.status == 1 ? parseFloat(data.get).toFixed(2) : parseFloat(data.price).toFixed(2)
        }</span>
                      <!---->
                  </div>
              </div>
          ...
          <div data-v-42f27458="" class="details display-none">
              ...
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                  ...
                  <div data-v-42f27458="">${parseFloat(data.money).toFixed(2)}</div>
              </div>
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
              ...
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                  ...
                  <div data-v-42f27458="" class="red">${parseFloat(data.price).toFixed(2)}</div>
              </div>
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                  <div data-v-42f27458="">Tax</div>
                  <div data-v-42f27458="">${parseFloat(data.fee).toFixed(2)}</div>
              </div>
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
            ...
            data.status == 1 ? "+" : "-"
        } ${data.status == 1 ? parseFloat(data.get).toFixed(2) : parseFloat(data.price).toFixed(2)}</div>
                  <!---->
              </div>
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
