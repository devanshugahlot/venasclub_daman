...
$(`.game-betting .box .item:eq(${selectPageTime - 1}) .img .van-image img`).attr('src', '/img/wingo/clock_3.png');
$(
  `.game-betting .box .item:eq(${selectPageTime - 1}) `
  ) .css("background", "url(/img/wingo/time_3.svg) no-repeat center center ");

$(
`.game-betting .box .item:eq(${selectPageTime - 1}) .triangle`
).css("border-top", ".24rem solid  #8cbffb");
$(
