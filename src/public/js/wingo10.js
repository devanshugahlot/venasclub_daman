                          ...
                          <div data-v-a9660e98="" class="item c-row">
                              ...
                              <div data-v-a9660e98="" class="c-row c-row-between info">
                                  ...
                                  <div data-v-a9660e98="" class="money">
                                           ${
                                               // list_orders.status==1 && list_orders.bet ==0 || list_orders.status==1 && list_orders.bet ==5 ||
...
).attr("src", "/img/wingo/clock_10.png");
$(
    `.game-betting .box .item:eq(${selectPageTime - 1}) `
    ) .css("background", "url(/img/wingo/time_10.svg) no-repeat center center ");
$(
    `.game-betting .box .item:eq(${selectPageTime - 1}) .triangle`
  ).css("border-top", ".24rem solid  #79cfef");
  $(
