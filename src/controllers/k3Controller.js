...
const rosesPlus = async (auth, money) => {
    ...
    let userInfo = user[0];
    let level0 = level[userInfo.vip_level];
...
const betK3 = async (req, res) => {
    try {
        ...
        if (gameJoin == 1) {
            ...
            total =
                money * xvalue * (lengthArr * count) + twoSame * money * xvalue;
        } else if (gameJoin == 3) {
            ...
            total =
                money * xvalue * countBaDuyNhat + threeSame * money * xvalue;
        } else if (gameJoin == 4) {
            ...
            for (let i = 0; i < arr3.length; i++) {
                if (arr3[i] != "") {
                    ...
                    if (check1 || check2) {
                        ...
                        let total =
                            orders.money / orders.amount / (lengthArr + bale);
        ...
        if (orders.typeGame == "three-same") {
            ...
            for (let i = 0; i < arr1.length; i++) {
                if (arr1[i] != "") {
                    ...
                    if (check1) {
                        let total =
                            orders.money / (arr1.length + bala) / orders.amount;
        ...
        if (orders.typeGame == "unlike") {
            ...
            for (let i = 0; i < arr3.length; i++) {
                if (arr1[i] != "") {
                    ...
                    if (!check1) {
                        let total =
                            orders.money / (arr3.length + bala) / orders.amount;
